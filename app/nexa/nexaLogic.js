...
function getAllDevices () {
    ...
    return new Promise(function(fulfill){
        var promiseOptions = requestOptions('GET', 
...
function pair () {
    ...
    return new Promise(function(fulfill){
        ...
        var promiseOptions = requestOptions('POST', 
...
function turnOn (id) {
    ...
    return new Promise(function(fulfill){
        ...
        var promiseOptions = requestOptions('GET', 'http://' + config.nexa.host + ':' + config.nexa.port + '/devices/' + id + '/on');
...
function turnOff (id) {
    ...
    return new Promise(function(fulfill){
        ...
        var promiseOptions = requestOptions('GET', 'http://' + config.nexa.host + ':' + config.nexa.port + '/devices/' + id + '/off');
